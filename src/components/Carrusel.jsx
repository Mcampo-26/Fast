      ...
      <Slider {...settings}>
        <div>
          <a href="https://www.instagram.com/reel/C2TYR1GOtGB/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer">
            <img src="https://st4.depositphotos.com/5586578/26307/i/450/depositphotos_263075430-stock-photo-computer-repair-service-hardware-support.jpg" alt="Image 3" className="w-full max-h-48 md:max-h-80 object-contain" />
          </a>
        </div>
